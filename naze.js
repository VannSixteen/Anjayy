...
const nyoutube = ('© Vann\nYoutube/Sc :\nhttps://youtube.com/channel/Vann')  //ubah di config biar ngk emror
...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "YT Naze", "caption": '©Vann', 'jpegThumbnail': thumb}}}
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'VannDev', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Vann Dev,;;;\nFN:Vann Dev\nitem1.TEL;waid=6285875158363:6285875158363\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/b5b5e8c292fa00382258b.png' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_https://saweria.co/.\n\n*Atau Transfer via*\n- *Dana*\n Ke nomer berikut : 082118596966\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('https://wa.me/6281287968321')
            }
            break		 
            case 'chat': {
